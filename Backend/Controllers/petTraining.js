...
const AddpetTrain = async (req, res)=>{
    try {
        ...
        const {image,date,days,organizationname, selectedpackage , includedservice,price,Restrictions,Duration,SelectedTiming, location,fullname,email,ownercontact,vendorcontact,vendoremail,status,bookedAt}=req.body;
        if(!date ){
        ...
        const pethostel = new PetTrainingModel({
            image,date,days,organizationname, selectedpackage, includedservice,price,Restrictions,Duration,SelectedTiming,location,fullname,email,ownercontact,vendorcontact,vendoremail,status,bookedAt
        })
