        ...
        const userData = JSON.parse(localStorage.getItem("user_data"));
             ...
             useEffect(() => {
               const fetchData = async () => {
                 try {
                   // Fetch adoption data
                   const adoptionResponse = await fetch("http://localhost:3000/groomingreview");
                   ...
                   const petListingResponse = await fetch("http://localhost:3000/groomingreview");
...
export default groomingRatingNotification
