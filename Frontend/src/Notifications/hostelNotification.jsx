import React, { useEffect, useState } from "react";
 ...
 const hostelNotification = () => {
     ...
     useEffect(() => {
       const fetchData = async () => {
         try {
           // Fetch adoption data
           const adoptionResponse = await fetch("http://localhost:3000/bookhostel");
           ...
           const petListingResponse = await fetch("http://localhost:3000/bookhostel");
     ...
     const handleApprove = async (petId) => {
       const result = await Swal.fire({
         title: "Are you sure?",
         text: "Do you want to complete this hostel service?",
         icon: "warning",
       ...
       try {
         ...
         const response = await fetch(`http://localhost:3000/bookhostel/${petId}`, {
           method: "PUT",
 ...
 export default hostelNotification