 ...
 const trainingNotification = () => {
     ...
     useEffect(() => {
       const fetchData = async () => {
         try {
           // Fetch adoption data
           const adoptionResponse = await fetch("http://localhost:3000/booktrain");
           ...
           const petListingResponse = await fetch("http://localhost:3000/booktrain");
     ...
     const handleApprove = async (petId) => {
       const result = await Swal.fire({
         title: "Are you sure?",
         text: "Do you want to complete this training service?",
         icon: "warning",
       ...
       try {
         ...
         const response = await fetch(`http://localhost:3000/booktrain/${petId}`, {
           method: "PUT",
