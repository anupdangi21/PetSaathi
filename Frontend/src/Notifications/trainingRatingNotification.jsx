            ...
            const userData = JSON.parse(localStorage.getItem("user_data"));
                 ...
                 useEffect(() => {
                   const fetchData = async () => {
                     try {
                       // Fetch adoption data
                       const adoptionResponse = await fetch("http://localhost:3000/trainingreview");
                       ...
                       const petListingResponse = await fetch("http://localhost:3000/trainingreview");
        ...
        {filteredAdoptions.map((adoption) => {
          ...
          const petFromListing = petListings.find(
            (pet) => pet.email === userData.user.email
                      ...
                      return (
            <div key={adoption._id} className="bg-white shadow-md rounded-lg p-4 w-96 mt-4 ml-4">
              <img
...
export default trainingRatingNotification
