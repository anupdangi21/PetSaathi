          ...
          const userData = JSON.parse(localStorage.getItem("user_data"));
               ...
               useEffect(() => {
                 const fetchData = async () => {
                   try {
                     // Fetch adoption data
                     const adoptionResponse = await fetch("http://localhost:3000/hostelreview");
                     ...
                     const petListingResponse = await fetch("http://localhost:3000/hostelreview");
...
export default hostelRatingNotification
