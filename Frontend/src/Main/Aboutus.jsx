...
const Aboutus = () => {
  return (
    <div className='container'>
        ...
        <main className='bg-bts'>
            <div className='text-center max-h-100 max-w-100 bg-bts mt-0'>
            ...
            <div>
              <div className="text-center text-2xl font-bold dark:text-black mt-10 bg-nav"> Why choose us
