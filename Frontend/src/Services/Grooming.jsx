    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-orange-200 to-orange-50 rounded-2xl p-8 mb-12 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {Array.isArray(showGroom) && showGroom.length > 0 ? (
            showGroom.map((pet) => (
            ...
            <p>No service available for grooming.</p>
          )}
        </div>
              ...
              <div className="p-6">
                ...
                {/* //{selectedPet.vendorcontact} */}
                  ...
                  <div className="col-span-2 mb-6 flex">
                    <span className='text-xl font-semibold'> Description:</span><p className=' ml-1 mt-0.5'>{selectedPet.description}</p>
                  </div>
